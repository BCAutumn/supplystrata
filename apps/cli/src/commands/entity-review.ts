...
function registerEntityCommands(program: Command): void {
  ...
  entity
    ...
    .option("--source <source>", "all, gleif, openfigi, wikidata, opencorporates, or companies-house", "all")
...
function registerReviewCommands(program: Command): void {
  ...
  reviewEnqueue
    ...
    .option("--source <source>", "gleif, openfigi, wikidata, opencorporates, companies-house, or all", "gleif")
