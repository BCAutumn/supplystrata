...
const SUGGESTION_SOURCE_RULES = [
  ...
  { token: "battery material supplier filings", sourceIds: ["company-ir", "sec-edgar", "edinet"] },
  { token: "anode supplier filings", sourceIds: ["company-ir", "sec-edgar", "edinet"] },
  { token: "critical mineral observations", sourceIds: ["usgs-mcs", "iea-critical-minerals", "worldbank-pink"] },
  { token: "rmi facility lists", sourceIds: ["rmi-facilities"] },
  { token: "responsible sourcing disclosures", sourceIds: ["company-ir", "sec-edgar", "rmi-facilities"] },
  ...
  { token: "server odm disclosures", sourceIds: ["sec-edgar", "company-ir", "twse-mops", "edinet"] },
  { token: "ai server bill of materials", sourceIds: ["sec-edgar", "company-ir", "twse-mops"] },
  { token: "odm disclosures", sourceIds: ["sec-edgar", "company-ir", "twse-mops", "edinet"] },
  { token: "pcb supplier filings", sourceIds: ["company-ir", "sec-edgar", "twse-mops", "edinet"] },
  { token: "laminate supplier filings", sourceIds: ["company-ir", "sec-edgar", "twse-mops", "edinet"] },
  { token: "copper foil supplier reports", sourceIds: ["company-ir", "sec-edgar", "twse-mops", "edinet"] },
  { token: "glass fiber supplier reports", sourceIds: ["company-ir", "sec-edgar", "edinet"] },
  { token: "resin supplier reports", sourceIds: ["company-ir", "sec-edgar", "edinet"] },
  { token: "networking supplier reports", sourceIds: ["company-ir", "sec-edgar"] },
  ...
  { token: "fab construction permits", sourceIds: ["osh", "company-ir"] },
