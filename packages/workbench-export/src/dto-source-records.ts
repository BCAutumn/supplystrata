...
export interface ClaimDtoSource {
  claim_id: string;
...
export interface EvidenceDtoSource {
  evidence_id: string;
  edge_id: string | null;
...
export interface UnknownDtoSource {
  unknown_id: string;
  scope_kind: string;
  scope_id: string;
  question: string;
...
export interface SourceHealthDtoSource {
  source_adapter_id: string;
  tier: string;
  category: string;
...
export interface ReviewCandidateDtoSource {
  review_id: string;
  kind: string;
...
export interface OfficialSignalDispositionDtoSource {
  change_id: string;
  review_id: string;
...
export interface ChangeTimelineDtoSource {
  event_id: string;
