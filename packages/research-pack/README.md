...
- 生成 `workbench`、CompanyCard、ChainCard、ComponentCard、question readiness、official disclosure readiness、source plan、source target coverage、investigation backlog、corroboration source plan、supply-chain expansion plan、Gate 1 run ledger 和 manifest。
