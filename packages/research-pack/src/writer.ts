...
function researchPackStatsLines(
  ...
  const commonLines = [
    ...
    mode === "truth_store"
      ? `- Source target coverage: ${stats.source_target_synced_targets}/${stats.source_target_expected_targets} synced; ${stats.source_target_due_targets} due`
