...
function researchPackStatsLines(
  ...
  const commonLines = [
    ...
    `- AI compute propagation matrix: ${stats.ai_compute_propagation_layers_total} layers; covered_fact ${stats.ai_compute_propagation_covered_fact}; observation_ready ${stats.ai_compute_propagation_observation_ready}; official_target_runnable ${stats.ai_compute_propagation_official_target_runnable}; lead_only ${stats.ai_compute_propagation_lead_only}; unknown_open ${stats.ai_compute_propagation_unknown_open}; blocked_source ${stats.ai_compute_propagation_blocked_source}; official evidence gaps ${stats.ai_compute_official_evidence_gaps} ${formatStatsCountMap(stats.ai_compute_official_evidence_gaps_by_kind)}`,
