...
export function manifestFromModel(input: {
  ...
  return {
    ...
    stats: {
      ...
      ai_compute_propagation_layers_total: input.propagationReadiness.ai_compute_matrix.summary.layers_total,
      ai_compute_propagation_covered_fact: input.propagationReadiness.ai_compute_matrix.summary.covered_fact,
      ai_compute_propagation_observation_ready: input.propagationReadiness.ai_compute_matrix.summary.observation_ready,
      ai_compute_propagation_official_target_runnable: input.propagationReadiness.ai_compute_matrix.summary.official_target_runnable,
