...
- 语义级写入事件第一版：`CLAIM_ADDED / CLAIM_UPDATED`、`OBSERVATION_ADDED / OBSERVATION_REASSERTED`、`LEAD_ADDED / LEAD_UPDATED`、`REVIEW_APPROVED / REVIEW_REJECTED / REVIEW_APPLIED / REVIEW_BLOCKED`、`UNKNOWN_ADDED / UNKNOWN_UPDATED / UNKNOWN_RESOLVED`。
