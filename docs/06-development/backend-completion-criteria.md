...
[x] source target preflight summary 能按 source 输出 readiness matrix，方便 Gate 1 多官方源体检
...
[x] source target preflight 能输出按 source 聚合的 checked / failed / skipped / normalized / degraded 矩阵
