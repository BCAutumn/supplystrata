...
8. [backend-completion-criteria.md](./docs/06-development/backend-completion-criteria.md) — 后端完成门槛
9. [roadmap.md](./docs/06-development/roadmap.md) — 历史阶段化开发记录
10. [v0.2-alpha-plan.md](./docs/06-development/v0.2-alpha-plan.md) — 下一版 alpha 的产品范围
11. [release-criteria.md](./docs/06-development/release-criteria.md) — 发布验收标准
12. [source-roi-matrix.md](./docs/04-data-sources/source-roi-matrix.md) — 数据源投入产出排序
13. [coverage-research-2026-05.md](./docs/04-data-sources/coverage-research-2026-05.md) — 最新数据覆盖研究与扩源顺序
14. [open-source-readiness.md](./docs/06-development/open-source-readiness.md) — 开源发布前体检
15. [quickstart.md](./docs/06-development/quickstart.md) — 从空环境跑到研究输出
...
后续方向看 [docs/06-development/backend-completion-criteria.md](./docs/06-development/backend-completion-criteria.md)。[roadmap.md](./docs/06-development/roadmap.md) 只保留历史阶段记录，不再作为“后端完成”的判断标准。
