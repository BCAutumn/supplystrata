...
12. [coverage-research-2026-05.md](./docs/04-data-sources/coverage-research-2026-05.md) — 最新数据覆盖研究与扩源顺序
13. [open-source-readiness.md](./docs/06-development/open-source-readiness.md) — 开源发布前体检
14. [quickstart.md](./docs/06-development/quickstart.md) — 从空环境跑到研究输出
